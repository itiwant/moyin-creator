        ...
        for (const vp of effectiveViewpoints) {
          ...
          if (splitResult) {
            ...
            if (splitResult.row !== expectRow || splitResult.col !== expectCol) {
              console.warn(`[AutoContactSheet] Trực tiếpchỉ mục不匹配: gridIndex=${gridIdx}, split[row=${splitResult.row},col=${splitResult.col}] vs expected[row=${expectRow},col=${expectCol}]`);
