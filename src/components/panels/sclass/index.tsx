    ...
    <div className="flex flex-col items-center justify-center h-full gap-4 p-6 text-center">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground max-w-[280px]">
          Vui lòng nhấp <span className="text-green-500 font-medium">+</span> Thêm phân cảnh vào panel này, hệ thống sẽ tự động phân nhómân nhómân nhómân nhómân nhómkính合并tự sựTạo video。
        </p>
