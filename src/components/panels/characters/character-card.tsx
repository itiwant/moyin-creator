    ...
    <ContextMenu>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            >
              ...
              {variationCount > 0 ? `${variationCount} biến thể` : "衣橱"}
            </Button>
          </div>
        </div>
      </div>
      ...
      {isSelected && character.views.length > 0 && (
        <div className="mt-3 pt-3 border-t">
          <div className="text-xs text-muted-foreground mb-2">Nhân vật视图</div>
      ...
      {isSelected && variationCount > 0 && (
        <div className="mt-3 pt-3 border-t">
          <div className="text-xs text-muted-foreground mb-2">衣橱biến thể</div>
          <div className="grid grid-cols-4 gap-2">
