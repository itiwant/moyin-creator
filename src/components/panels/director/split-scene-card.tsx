...
export function SplitSceneCard({
  ...
  const handleSavePrompt = () => {
    ...
    if (editingPrompt === 'image') {
      ...
      toast.success(`Đã cập nhật gợi ý ${langLabel} video phân cảnh ${scene.id + 1}`);
      ...
      toast.success(`Đã cập nhật gợi ý ${langLabel} khung hình cuối phân cảnh ${scene.id + 1}`);
    }
      ...
      <div className="flex items-center justify-between px-3 py-1.5 bg-muted/30 border-b">
        ...
        {!isGeneratingAny && (
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>XóaPhân cảnh #{scene.id + 1}？</AlertDialogTitle>
                <AlertDialogDescription>
                  Thao tác này sẽ xóa toàn bộ nội dung phân cảnh này, không thể hoàn tác.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
            ...
            <div 
              ...
              onClick={() => {
                ...
                if (hasImage && resolvedImageUrl) {
                  setPreviewItem({ type: 'image', url: resolvedImageUrl, name: `Phân cảnh ${scene.id + 1} Khung hình đầu` });
                } else {
              ...
              {hasImage ? (
                <>
                  <img
                    ...
                    alt={`Phân cảnh ${scene.id + 1} Khung hình đầu`}
            ...
            >
              {hasEndFrame ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center gap-1 bg-orange-500/5">
                  ...
                  <span className="text-[10px] text-orange-500/70">CầnKhung hình cuối</span>
                </div>
              ) : (
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent side="top">
                    <p className="text-xs">Trích xuất khung cuối vào khung hình đầu phân cảnh tiếp theo</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
            ...
            <div className="space-y-2 pl-1">
              ...
              <div className="border-l-[3px] border-violet-500 pl-3 py-1 space-y-1">
                <Label className="text-[10px] text-violet-600 dark:text-violet-400 flex items-center gap-1 font-medium">
                  ...
                  Hành động kịch bản (nguồn gợi ý)
                </Label>
                <div className="rounded bg-violet-500/5 border border-violet-500/10">
                  <EditableTextField
                    ...
                    placeholder="Nhấp đúp thêm mô tả hành động (AI sẽ tạo ba lớp gợi ý từ đây)..."
                    disabled={isGeneratingAny}
                    multiline
                  />
                </div>
                ...
                {editingPrompt === 'image' ? (
                  <>
                    <Textarea
                      ...
                      placeholder="Mô tả ảnh tĩnh của khung hình đầu..."
                      autoFocus
                    />
                  ...
                  >
                    <p className="text-[11px] text-muted-foreground flex-1 line-clamp-6 min-h-[4.5em]">
                      {getPromptByLanguage(scene.imagePromptZh, scene.imagePrompt) || "Nhấp để thêm mô tả khung hình đầu..."}
                    </p>
              ...
              <div className="border-l-[3px] border-orange-500 pl-3 py-1 space-y-1">
                <Label className="text-[10px] text-orange-600 dark:text-orange-400 flex items-center gap-1 font-medium">
                  <span>◉</span>
                  Gợi ý khung hình cuối{scene.needsEndFrame ? '' : '（Tùy chọn）'}
                </Label>
                {editingPrompt === 'endFrame' ? (
                  <>
                    <Textarea
                      ...
                      placeholder="Mô tả ảnh tĩnh của khung hình cuối..."
                      autoFocus
                    />
                    <div className="flex gap-1 justify-end mt-1">
                      <Button variant="outline" size="sm" onClick={handleCancelEdit} className="h-5 px-2 text-[10px]">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <input
              ...
              placeholder="Hội thoại nhân vật..."
          ...
          <div className="flex items-center gap-1.5">
            ...
            <input
              ...
              placeholder="Nhạc nền mặc định bị tắt, hãy bật và điền nếu cần..."
