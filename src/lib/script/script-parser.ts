...
7. Ngôn ngữ与người dùng输入保持一致（đang xử lý...用đang xử lý...）
8. **thời đại一致性**：đại cươngđang xử lý...确thời đại背景；nhân vật小传đang xử lý...、Kiểu tóc、đạo cụ必须严格符合该thời đại（如古代剧不得出现现代trang phục/电子产品；现代剧不得出现古代服饰）
