  ...
  "characters": [
    {
      ...
      "gender": "Giới tính",
      "age": "年龄",
      "role": "详细的身份背景Mô tả，包括职业、地位、背景故事等",
      "personality": "详细的性格特点Mô tả，包括处事方式、价值观等",
      "traits": "Đặc trưng cốt lõi的详细Mô tả，包括突出能力、特点等",
      "skills": "Kỹ năng/năng lựcMô tả（如武功招式、魔法、专业技能等）",
...
1. 【角色信息必须详细】：不要简化角色信息！保留原文đang xử lý...t cả细节：
   ...
   - personality: đầy đủ的性格Mô tả（如"重侠义、护苍生、轻权位、有原则，面对构陷不屑辩解..."）
...
2. 一动作行：△[将该镜头Tất cả画面、动作、Thoại、音效等压缩为一句đầy đủ的Mô tả thị giác]

禁止在场景内写多行！禁止分别列出Thoại、音效！Tất cả内容必须压缩到一 △ 行中。

示例：
用户输入【镜头1】包含画面Mô tả+Thoại+音效，你的输出应该是：
**1-1 日 内 篮球馆**
nhân vật：马一花、沈星晴
